...
public class ListEmp extends javax.swing.JInternalFrame {
    ...
    public ListEmp() {
        ...
        lista.listEmp(cod, nom, dir, tel, dpi, email, nit);
        generar();
    }
    private void generar(){
       ...
       int cantRow = jList.getRowCount();
        ...
        //Agregar listado
        while (cod.peek() != null) {            
                String data[] = {(String)cod.poll(),(String)nom.poll(),(String)dir.poll(),(String)tel.poll(),
                    (String)dpi.poll(),(String)email.poll(),(String)nit.poll()};
                dfm.addRow(data);
        }
    ...
    private void initComponents() {
        ...
        jList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Direccion", "Telefono", "DPI", "Email", "NIT"
            }
        ));
    ...
    private void btnNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNameActionPerformed
        ...
        try{
            ...
            Listados lista = new Listados();
            lista.listEmpName(name, cod, nom, dir, tel, dpi, email, nit);
            generar();
        }catch(Exception e){
    ...
    private void btnCodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCodActionPerformed
        ...
        try{
            ...
            Listados lista = new Listados();
            lista.listEmpCod(cod1, cod, nom, dir, tel, dpi, email, nit);
            generar();
        }catch(Exception e){
