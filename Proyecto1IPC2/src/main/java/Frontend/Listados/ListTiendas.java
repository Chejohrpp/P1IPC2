 ...
 * @author chejohrpp
 */
public class ListTiendas extends javax.swing.JInternalFrame {
    ...
    private LinkedList tel1 = new LinkedList();
    private LinkedList tel2 = new LinkedList();
    private LinkedList email = new LinkedList();
    private LinkedList hor = new LinkedList();
    /**
     * Creates new form ListTiendas
     */
    public ListTiendas() {
        initComponents();
        dfm = (DefaultTableModel) jList.getModel();
        Listados lista = new Listados();
        lista.listTiendas(cod, nom, dir, tel1, tel2, email, hor);
        generar();
    }
    private void generar(){
       ...
       int cantRow = jList.getRowCount();
        ...
        //Agregar listado
        while (cod.peek() != null) {            
                String data[] = {(String)cod.poll(),(String)nom.poll(),(String)dir.poll(),(String)tel1.poll(),
                    (String)tel2.poll(),(String)email.poll(),(String)hor.poll()};
                dfm.addRow(data);
        }
    ...
    private void initComponents() {
        ...
        jList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Direccion", "Telefono 1", "Telefono 2", "Email", "Horario"
            }
        ));
    ...
    private void btnCodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCodActionPerformed
        ...
        try{
            ...
            Listados lista = new Listados();
            lista.listTiendasCod(cod1, cod, nom, dir, tel1, tel2, email, hor);
            generar();
        }catch(Exception e){
    ...
    private void btnNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNameActionPerformed
        ...
        try{
            ...
            Listados lista = new Listados();
            lista.listTiendasName(name, cod, nom, dir, tel1, tel2, email, hor);
            generar();
        }catch(Exception e){
