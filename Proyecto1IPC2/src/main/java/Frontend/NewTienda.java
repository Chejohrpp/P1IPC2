 ...
 * @author chejohrpp
 */
public class NewTienda extends javax.swing.JFrame {
    private boolean ingreso = true;
    
    /**
     * Creates new form NewTienda1
     */
    public NewTienda() {
        ingreso = true;
        initComponents();
    ...
    public NewTienda(String titulo) {        
        ingreso = false;
        initComponents();        
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Ingreso de nueva tienda");
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        try{
            ...
            String hor = txtHorario.getText();
            if (isEmpty(email)) {
                throw new IllegalArgumentException("Faltan datos por llenar");
            }
            if (ingreso) {
                ingresar(codigo,nombre,tel1,tel2,email,hor,dir);
            } else{
                mod(codigo,nombre,tel1,tel2,email,hor,dir);
            }
        }catch(Exception e){
            System.out.println(e.getMessage());
            JOptionPane.showMessageDialog(null, "Datos no validados, revise los datos ingresados", "ERORR", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void ingresar(String codigo,String nombre, String tel1,String tel2,String email,String hor, String dir){
        try{
            
            AgregarDB agregar = new AgregarDB();
            agregar.addTienda(this,codigo, nombre, tel1, tel2, email, hor, dir);
            
        }catch(Exception e){
            System.out.println(e.getMessage());
        }
    }
    private void mod(String codigo,String nombre, String tel1,String tel2,String email,String hor, String dir){
        try{
            ModDB mod = new ModDB();
            mod.modTienda(this,codigo, nombre, tel1, tel2, email, hor, dir);
        }catch(Exception e){
            System.out.println(e.getMessage());
        }
     ...
     private boolean isEmpty(String email) {
      ...
      private void cambiarTien(){
        ...
        try( Connection connection = con.getConnection()){
            ...
            try(PreparedStatement preSt = connection.prepareStatement(query)){
                ...
                JComboBox camTien = new JComboBox();//creamos un JComboBox
                //agregamos los nombres al JComboBox
                while(result.next()){
                    camTien.addItem(result.getString(1));
                }
                //hacemos que el usuario seleccione la tienda
                //camTien.setEditable(true);
                JOptionPane.showMessageDialog(null, camTien, "Seleccione el codigo de la tienda", JOptionPane.QUESTION_MESSAGE);
                String codigo = camTien.getSelectedItem().toString();
                //colocamos el codigo en la caja de texto
                txtCod.setText(codigo);
                codTienda(codigo,connection);
                result.close();
      ...
      private void codTienda(String codigo,Connection connection){
        String query = "SELECT nombre,telefono1,telefono2,direccion,email,horario from tienda WHERE codigo= ?";
        try(PreparedStatement preSt = connection.prepareStatement(query)){
            ...
            if (result.next()) {
                ...
                txtTel1.setText(result.getString(2));
                txtTel2.setText(result.getString(3));
                txtDireccion.setText(result.getString(4));
                txtEmail.setText(result.getString(5));
                txtHorario.setText(result.getString(6));
